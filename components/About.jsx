...
const About = () => {
  ...
  return (
    <section className="xl:h-[860px] xl:py-24 py-12 mb-12 xl:mb-36 bg-gradient-to-b from-[#c1c3c9] to-[#f9f9f9] dark:bg-gradient-to-b  dark:from-[#1d1f25] dark:to-[#0f0f12]">
