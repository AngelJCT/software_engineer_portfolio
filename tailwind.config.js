...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      animation: {
        "slow-pulse": "pulse 2s cubic-beizer(0.4, 0, 0.6, 1) infinite",
      },
      colors: {
      ...
      backgroundImage: {
        logo_image: "url(/svg/Asset 1.svg)",
        logo_image2: "url(/svg/Asset 2.svg)",
        hero: "url(/hero/angel_carrion59_a_close_up_view_of_an_abstract_minimalistic_wave_upscaled.png)",
